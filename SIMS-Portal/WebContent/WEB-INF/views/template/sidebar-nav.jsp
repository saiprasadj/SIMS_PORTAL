			...
			<ul class="nav">
				...
				<sec:authorize access="hasRole('ROLE_USER')">
					...
					<li
						...
						<a href="${accountMasterURL}"> <i class="fa fa-line-chart"></i> <spring:message
								code="sims.portal.homepage.navbar.masters.account" />
					</a>
					</li>

					<c:url var="departmentMasterURL" value="/admin/department" />
					<li
						class="${fn:contains(currentUrl, departmentMasterURL) ? 'active' : ''}">
						<a href="${departmentMasterURL}"> <i class="fa fa-users"></i> <spring:message
								code="sims.portal.homepage.navbar.masters.department" />
					</a>
					</li>

					<c:url var="employeeMasterURL" value="/admin/employee" />
					<li
					...
					<c:url var="productMasterURL" value="/admin/product" />
					<li
						class="${fn:contains(currentUrl, productMasterURL) ? 'active' : ''}">
						<a href="${productMasterURL}"> <i class="glyphicon glyphicon-pencil"></i> <spring:message
								code="sims.portal.homepage.navbar.masters.product" />
					</a>
					</li>

					<c:url var="sectionMasterURL" value="/admin/section" />
					<li
						class="${fn:contains(currentUrl, sectionMasterURL) ? 'active' : ''}">
						<a href="${accountMasterURL}"> <i class="fa fa-home"></i> <spring:message
