	...
	<section>
			...
			<li class="${listPageActive}"><a data-toggle="tab"
				href="#listpage">
					<h6 class="form-header hidden-xs-down">
						<spring:message code="sims.portal.masters.sectionmaster.list" />
					</h6>
			</a></li>
			<li class="${detailsPageActive}"><a data-toggle="tab"
				href="#detailspage">
					<h6 class="form-header hidden-xs-down">
						<spring:message code="sims.portal.masters.sectionmaster.details" />
					</h6>
			</a></li>
		</ul>
		...
		<div
			...
			<div id="listpage" class="tab-pane fade ${listPage}">
				<masterslist:sectionmasterlist />
			</div>
			<div id="detailspage" class="tab-pane fade ${detailsPage}">
				<mastersdetails:sectionmasterdetails
					sectionDetailsForm="${accountMasterForm}" />
			</div>
