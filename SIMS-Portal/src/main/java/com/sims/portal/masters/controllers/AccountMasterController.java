...
public class AccountMasterController {
	...
	public ModelAndView findAccountMasterDetailsByCode(@PathVariable(name = "code") String accountMasterCode) {
		...
		modelAndView.addObject("accountMasterURL", "account/update");

		return modelAndView;
	}
	
	@RequestMapping(value = "/update/{id}", method = RequestMethod.POST)
	public ModelAndView updateAccountMaster(@PathVariable(name="id")Long id,@ModelAttribute("accountMasterForm") AccountMasterForm accountMasterForm) {
	...
	public ModelAndView deleteAccountMasterDetailsByCode(@PathVariable(name = "id") Long id,@ModelAttribute("accountMasterForm") AccountMasterForm accountMasterForm) {
