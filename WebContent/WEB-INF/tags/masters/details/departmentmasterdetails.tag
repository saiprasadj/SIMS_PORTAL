...
<%@ attribute name="departmentDetailsForm" required="true"%>
...
<form:form id="departmentMasterDetailsForm"
	modelAttribute="departmentMasterForm"
	action="${pageContext.request.contextPath}/master/${departmentMasterURL}"
	method="POST" onsubmit="return validateform()">
	
	===========ID==${departmentMasterForm.id}==========================
	<div class="row">
		<div class="col-lg-12">
			<h5>Department Master Details</h5>
	...
	<div class="col-lg-12">
		<div class="row">
			<c:choose>
				<c:when test="${departmentMasterURL == 'department/save'}">
					<div class="col-xs-6">
