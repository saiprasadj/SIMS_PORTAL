...
<%@ attribute name="wareHouseDetailsForm" required="true"%>
...
<form:form id="wareHouseMasterDetailsForm"
	modelAttribute="wareHouseMasterForm"
	action="${pageContext.request.contextPath}/master/${wareHouseMasterURL}"
	method="POST" onsubmit="return validateform()">
	
	===========ID==${wareHouseMasterForm.id}==========================
	<div class="row">
		<div class="col-lg-12">
			<h5>WareHouse Master Details</h5>
	...
	<div class="col-lg-12">
		<div class="row">
			<c:choose>
				<c:when test="${wareHouseMasterURL == 'warehouse/save'}">
					<div class="col-xs-6">
