	...
	<section>
		...
		<ul id="top-bar" class="nav nav-tabs nav-justified">
			<li class="${listPageActive}"><a data-toggle="tab" href="#listpage">
					<h6 class="form-header hidden-xs-down">
						<spring:message code="sims.portal.masters.warehousemaster.list" />
					</h6>
			</a></li>
			<li class="${detailsPageActive}"><a data-toggle="tab" href="#detailspage">
					<h6 class="form-header hidden-xs-down">
						<spring:message code="sims.portal.masters.warehousemaster.details" />
					</h6>
			</a></li>
		</ul>
		...
		<div
			...
			<div id="listpage" class="tab-pane fade ${listPage}">
				<masterslist:warehousemasterlist />
			</div>
			<div id="detailspage" class="tab-pane fade ${detailsPage}">
				<mastersdetails:warehousemasterdetails
					wareHouseDetailsForm="${wareHouseDetailsForm}" />
			</div>
